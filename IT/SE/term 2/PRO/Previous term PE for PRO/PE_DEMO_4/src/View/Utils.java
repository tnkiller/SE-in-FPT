...
public class Utils {
    ...
    //check INTEGER
    public static int checkIntData(String msg) {
        while (true) {
            try {
                int data = Integer.parseInt(inputValue(msg));
                return data;
    ...
    //check DOUBLE
    public static double checkDoubleData(String msg) {
        while (true) {
            try {
                double data = Double.parseDouble(inputValue(msg));
                return data;
            } catch (NumberFormatException nfe) {
                System.out.println("Please enter exactly");
            }
