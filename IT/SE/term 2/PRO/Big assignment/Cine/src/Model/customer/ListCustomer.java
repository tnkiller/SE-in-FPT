...
public class ListCustomer {
    ...
    public Customer searchCustomer1(String userName) {
        ListCustomer listCustomer= new ListCustomer();
        for (Customer customer : listCustomer.customers) {
            if (customer.getUserName().equals(userName)) {
                return customer;
...
//        while (running) {
    ...
    public void addNewCustomer() {
        ...
        String address = Validation.formatEmail("Enter E-mail: ");
        String phoneNum = Validation.formatPhoneNumber("Enter phone number: ");
        Date dob = Validation.checkInputDate("Enter DOB (dd/MM/yyyy): ");
    ...
    private void updateCustomerInfo() {
        ...
        if (customer != null) {
            ...
            String newAddress = Validation.formatEmail("Enter new E-mail: ");
            String newPhoneNum = Validation.formatPhoneNumber("Enter new phone number: ");
